...
def processRequest(req):
    if req.get("queryResult").get("action") == "yahooWeatherForecast":
        ...
        return {
            ...
            "outputContexts": [
                {"name": 'projects/${PROJECT_ID}/agent/sessions/${SESSION_ID}/contexts/new_context', "lifespanCount": 5, "parameters": {"emp_id.original": '001208'}}
            ]
            # "data": {},
            # "contextOut": [],
...
def makeWebhookResult(data):
    ...
    speech = " Hellooooo Tahsin!! Today the weather in " + location.get('city') + " is : " + condition.get('text') + \
